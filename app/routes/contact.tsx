...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Contact - Muhammad Faza Al-Banna" },
    { name: "description", content: "Get in touch with Muhammad Faza Al-Banna for collaborations, opportunities, or questions about projects and technology." },
    { name: "keywords", content: "Contact Faza, Muhammad Faza Al-Banna, Collaboration, Opportunities, Developer Contact" },
  ];
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-4 mb-12">
                {SOCIAL_LINKS.map((social, index) => (
                  <a
                    ...
                    className="flex items-center p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow animate-fade-in"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <div className={`w-12 h-12 ${social.color} rounded-lg flex items-center justify-center text-white mr-4`}>
                      {socialIcons[social.name as keyof typeof socialIcons]}
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900">{social.name}</h3>
                      <p className="text-gray-600 text-sm">Connect with me on {social.name}</p>
                    </div>
              ...
              {/* Quick Info */}
              <div className="bg-gradient-to-br from-primary-light to-primary p-8 rounded-2xl text-white">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center">
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m8 6V9a2 2 0 00-2-2H8a2 2 0 00-2 2v3m8 0a2 2 0 002 2v0a2 2 0 002-2m-6 0a2 2 0 002 2v0a2 2 0 002-2" />
                    </svg>
